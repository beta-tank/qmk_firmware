 ...
 * |-------+------+------+------+------+------|  MUTE  |   |       |------+------+------+--------+--------+------------|
 * |  LAlt | Undo |  Cut | Copy | Paste|      |-------|    |-------| Vol- | End  | Pscr | PgDown | PsBrk | RAlt        |
 * `------------------------------------------/       /     \      \---------------------------------------------------'
 *           | LGUI | LAlt | TAB  | SPACE  | /Enter  /       \ ESC  \  | BckSP  | DEL  | RAlt | RGUI |
 *           |      |      | RISE | LSHIFT |/ LOWER /        \ LOWER \ | RSHIFT | RISE |      |      |
 *           `------------------------------------'           '-------''------------------------------'
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_UNDO,  KC_CUT,   KC_COPY, KC_PASTE, XXXXXXX,   _______,       _______, KC_VOLD, KC_END,   KC_PSCR,   KC_PGDN,   KC_PAUS, _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
